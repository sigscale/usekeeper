...
voice_spec() ->
	...
	CharValueFrom1 = 1,
	CharValueTo1 = 999,
	CharValueSpec1 = #spec_char_value{value_type = CharValueType1,
			from = CharValueFrom1, to = CharValueTo1},
	CharSpec1 = #specification_char{name = CharName1,
			description = CharDescription1,
			configurable = CharConfig1,
			char_value = [CharValueSpec1]},
	CharName2 = "originatingNumber",
	CharDescription2 = "Caller's directory number",
	CharConfig2 = true,
	CharValueType2 = "string",
	CharValueSpec2 = #spec_char_value{value_type = CharValueType2},
	CharSpec2 = #specification_char{name = CharName2,
			description = CharDescription2,
			configurable = CharConfig2,
			char_value = [CharValueSpec2]},
	...
	CharValueFrom3 = 1,
	CharValueTo3 = 999,
	CharValueSpec3 = #spec_char_value{value_type = CharValueType3,
			from = CharValueFrom3, to = CharValueTo3},
	CharSpec3 = #specification_char{name = CharName3,
			description = CharDescription3,
			configurable = CharConfig3,
			char_value = [CharValueSpec3]},
	CharName4 = "destinationNumber",
	CharDescription4 = "Callee's directory number",
	CharConfig4 = true,
	CharValueType4 = "string",
	CharValueSpec4 = #spec_char_value{value_type = CharValueType4},
	CharSpec4 = #specification_char{name = CharName4,
			description = CharDescription4,
			configurable = CharConfig4,
			char_value = [CharValueSpec4]},
	CharName5 = "duration",
	CharDescription5 = "Duration of the call",
	CharConfig5 = true,
	CharValueType5 = "number",
	CharValueFrom5 = 0,
	CharValueSpec5 = #spec_char_value{value_type = CharValueType5,
			from = CharValueFrom5},
	CharSpec5 = #specification_char{name = CharName5,
			description = CharDescription5,
			configurable = CharConfig5,
			char_value = [CharValueSpec5]},
	CharName6 = "startDateTime",
	CharDescription6 = "Start time of the call",
	CharConfig6 = true,
	CharValueType6 = "dateTime",
	CharValueSpec6 = #spec_char_value{value_type = CharValueType6},
	CharSpec6 = #specification_char{name = CharName6,
			description = CharDescription6,
			configurable = CharConfig6,
			char_value = [CharValueSpec6]},
	CharName7 = "answerDateTime",
	CharDescription7 = "Time the call was answered",
	CharConfig7 = true,
	CharValueType7 = "dateTime",
	CharValueSpec7 = #spec_char_value{value_type = CharValueType7},
	CharSpec7 = #specification_char{name = CharName7,
			description = CharDescription7,
			configurable = CharConfig7,
			char_value = [CharValueSpec7]},
	CharName8 = "endDateTime",
	CharDescription8 = "End time of the call",
	CharConfig8 = true,
	CharValueType8 = "dateTime",
	CharValueSpec8 = #spec_char_value{value_type = CharValueType8},
	CharSpec8 = #specification_char{name = CharName8,
			description = CharDescription8,
			configurable = CharConfig8,
			char_value = [CharValueSpec8]},
	#use_spec{name = Name, description = Description,
			start_date = StartDate, end_date = EndDate,
			characteristic = [CharSpec1, CharSpec2, CharSpec3, CharSpec4,
					CharSpec5, CharSpec6, CharSpec7, CharSpec8]}.
