...
voice_usage() ->
	...
	CharName1 = "poolNumber",
	CharName2 = "characteristicType",
	CharName3 = "value",
	CharName4 = "unit",
	UsageChar1 = #{"name" => CharName1, "value" => 1},
	UsageChar2 = #{"name" => CharName2, "value" => "Reserved"},
	UsageChar3 = #{"name" => CharName3, "value" => 2},
	UsageChar4 = #{"name" => CharName4, "value" => "GHZ"},
	RelatedParty1 = #{"id" => RelatedId1, "role" => "customer"},
	RelatedParty2 = #{"id" => RelatedId2, "role" => "supplier"},
	Rated = #{"ratingDate" => Date, "taxIncludedRatingAmount" => "12",
			"taxExcludedRatingAmount" => "10", "productRef" => "ref",
	...
	#{"description" => Description,
			...
			"type" => "CloudCpuUsage",
			"usageCharacteristic" => #{CharName1 => UsageChar1,
					CharName2 => UsageChar2, CharName3 => UsageChar3,
					CharName4 => UsageChar4},
			"relatedParty" => #{RelatedId1 => RelatedParty1, RelatedId2 => RelatedParty2},
