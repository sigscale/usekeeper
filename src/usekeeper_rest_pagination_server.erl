%%% usekeeper_rest_pagination_server.erl
%%% vim: ts=3
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%
-module(usekeeper_rest_pagination_server).
-copyright('Copyright (c) 2019 SigScale Global Inc.').

-behaviour(gen_server).

%% export the usekeeper_rest_pagination_server API
-export([start_link/1]).
...
%%----------------------------------------------------------------------
%%  The usekeeper_rest_pagination_server API
%%----------------------------------------------------------------------
...
%%----------------------------------------------------------------------
%%  The usekeeper_rest_pagination_server gen_server call backs
%%----------------------------------------------------------------------
...
range_request({StartRange, EndRange}, From,
	...
	case apply(Module, Function, [Cont1, Size, Buffer | Args]) of
		{error, _Reason} ->
		...
		{_Cont2, NumItems, Total} when is_integer(NumItems), Size == undefined ->
			...
			{stop, shutdown, {undefined, ContentRange}, State};
